/* ==================================================================
 * CallMessageProcessor.java - 2/02/2020 5:33:30 pm
 * 
...
/**
 * API for processing {@link CallMessage} objects.
 * 
 * @author matt
 * @version 1.0
 */
public interface CallMessageProcessor {
	 ...
	 */
	void processCallMessage(CallMessage message, CallMessageResultHandler resultHandler);
